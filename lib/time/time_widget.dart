    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<EmpresasRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final timeEmpresasRecord = snapshot.data!;
                    ...
                    if (responsiveVisibility(
                      ...
                      wrapWithModel(
                        ...
                        child: MenuSideBarTabletWidget(
                          ...
                          backgroundLeads:
                              FlutterFlowTheme.of(context).secondaryBackground,
                          backgroundMeuTime: valueOrDefault<Color>(
                          ...
                          pathIcon: valueOrDefault<String>(
                            (Theme.of(context).brightness == Brightness.dark) ==
                                    false
                                ? valueOrDefault<String>(
                                    timeEmpresasRecord.logo,
                                    'https://firebasestorage.googleapis.com/v0/b/web-app-crm-prod.firebasestorage.app/o/upload-image.png?alt=media&token=8805cabf-ecc6-4821-8435-415ad3728358',
                                  )
                                : valueOrDefault<String>(
                                    timeEmpresasRecord.logoDk,
                                    'https://firebasestorage.googleapis.com/v0/b/web-app-crm-prod.firebasestorage.app/o/upload-image.png?alt=media&token=8805cabf-ecc6-4821-8435-415ad3728358',
                                  ),
                            'https://firebasestorage.googleapis.com/v0/b/web-app-crm-prod.firebasestorage.app/o/upload-image.png?alt=media&token=8805cabf-ecc6-4821-8435-415ad3728358',
                          ),
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'Envie seu link para chamar novos membros'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
