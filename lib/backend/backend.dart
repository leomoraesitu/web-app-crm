...
import 'schema/fonte_leads_record.dart';
...
export 'schema/fonte_leads_record.dart';
...
/// Functions to query FonteLeadsRecords (as a Stream and as a Future).
Future<int> queryFonteLeadsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FonteLeadsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FonteLeadsRecord>> queryFonteLeadsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      FonteLeadsRecord.collection(parent),
      FonteLeadsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FonteLeadsRecord>> queryFonteLeadsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
